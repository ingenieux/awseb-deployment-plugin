...
public class AWSEBDeploymentConfig implements Serializable {
    ...
    public List<String> getEnvironmentNames() {
        ...
        String csEnvironmentNames = this.environmentNames;
        if (csEnvironmentNames.contains(",")) {
            return environmentNames = new ArrayList<>(Arrays.asList(csEnvironmentNames.split("\\s*,\\s*")));
        }
        environmentNames = new ArrayList<>();
        environmentNames.add(csEnvironmentNames);
